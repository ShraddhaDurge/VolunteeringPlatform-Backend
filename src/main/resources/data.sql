...
INSERT INTO user (user_id, email, first_name, last_name, password, active, role) VALUES (11,'Nikita.Deore@gmail.com','Nikita','Deore','$2a$10$j9amWymVTsGRxLSo8aLhkuN9HaWHGpsrK9sNxXOlb3u0LSPP/goMq',1,'ADMIN');
INSERT INTO user (user_id, email, first_name, last_name, password, active, role) VALUES (12,'Ajit.Kale@gmail.com','Ajit','Kale','$2a$10$Av39pS3b1uNlQnzz6lWrKOcl1CJzL9oA41IsEqJ96GJy1sUt9o49S',1,'ADMIN');
INSERT INTO user (user_id, email, first_name, last_name, password, active, role) VALUES (13,'Priya.Kate@gmail.com','Priya','Kate','$2a$10$SBehPJvm5jWQGmmfTRDtiurFizPhZ2qzIo.hUd19DTkz0kL4IoPku',1,'LEADER');
INSERT INTO user (user_id, email, first_name, last_name, password, active, role) VALUES (14,'Akid.Khan@gmail.com','Akid','Khan','$2a$10$qsYFGexi12e3pWFM/maa/.n9DLOFWoHV2mL3iU7TclIiv.VAcR6Qq',1,'LEADER');
