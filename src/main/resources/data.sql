INSERT INTO event (event_id, event_type, name, description, venue, start_time, end_time) VALUES (1, 'Weekend event','Animal Shelter', 'Animal Shelter', 'Mumbai','2021-08-20T17:30:00.000+00','2021-08-20T20:30:00.000+00');
INSERT INTO event (event_id, event_type, name, description, venue, start_time, end_time) VALUES (2, 'Weekend event','Children Home', 'Children Home', 'Bangalore', '2021-08-23T18:30:00.000+00','2021-08-20T20:30:00.000+00');
INSERT INTO event (event_id, event_type, name, description, venue, start_time, end_time) VALUES (3, 'Weekend event','Old Age Home', 'Old Age Home', 'Delhi', '2021-07-20T17:30:00.000+00','2021-07-20T20:30:00.000+00');
INSERT INTO event (event_id, event_type, name, description, venue, start_time, end_time) VALUES (4, 'Weekend event','Green Earth', 'Green Earth', 'Chennai',  '2021-07-20T17:30:00.000+00','2021-07-20T20:30:00.000+00');
...
INSERT INTO user (user_id, email, first_name, last_name, password, active, role, hours) VALUES (2,'spdurge99@gmail.com','Ajit','Kale','$2a$10$Av39pS3b1uNlQnzz6lWrKOcl1CJzL9oA41IsEqJ96GJy1sUt9o49S',1,'ADMIN',2);
INSERT INTO user (user_id, email, first_name, last_name, password, active, role, hours) VALUES (3,'spdurge99@gmail.com','Priya','Kate','$2a$10$SBehPJvm5jWQGmmfTRDtiurFizPhZ2qzIo.hUd19DTkz0kL4IoPku',1,'LEADER',3);
INSERT INTO user (user_id, email, first_name, last_name, password, active, role, hours) VALUES (4,'spdurge99@gmail.com','Akid','Khan','$2a$10$qsYFGexi12e3pWFM/maa/.n9DLOFWoHV2mL3iU7TclIiv.VAcR6Qq',1,'LEADER',2);
